...
public class Sound {
    ...
    public Sound(String filepath, boolean doesLoop){
        ...
        //Retrieve extra information that was stored in the buffers by stb
        int channels  = channelsBuffer.get();
        int samplerRate = sampleRateBuffer.get();
        ...
        //Create space to hold audio sample
        bufferId = alGenBuffers();
        alBufferData(bufferId, format, rawAudioBuffer, samplerRate);
